...
export type NotionBlocks = Bookmark | BulletedListItem | Callout | Code | ColumnList | Column | Divider | Equation | FileBlock | Header1 | Header2 | Header3 | Image | NumberedListItem | Paragraph | Quote | Table | TableRow | ToDo | Toggle | Video;
